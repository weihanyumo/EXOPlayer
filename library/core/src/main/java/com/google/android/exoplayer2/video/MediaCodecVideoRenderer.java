...
//      android.util.Log.d(TAG, "logtest  maybeNotifyRenderedFirstFrame: ");
  ...
  @RequiresApi(21)
  private void configureTunnelingV21(MediaFormat mediaFormat, int tunnelingAudioSessionId) {
    mediaFormat.setFeatureEnabled(CodecCapabilities.FEATURE_TunneledPlayback, true);
    if (getConfiguration().haveAudio) {
      mediaFormat.setInteger(MediaFormat.KEY_AUDIO_SESSION_ID, tunnelingAudioSessionId);
    } else {
      mediaFormat.setInteger("audio-hw-sync", -2);
    }
  }
