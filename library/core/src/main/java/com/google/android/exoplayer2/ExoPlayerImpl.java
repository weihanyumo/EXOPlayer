...
import static com.google.android.exoplayer2.Renderer.MSG_SET_PRIORITY;
...
/* package */ final class ExoPlayerImpl extends BasePlayer
  ...
  public ExoPlayerImpl(ExoPlayer.Builder builder, @Nullable Player wrappingPlayer) {
    ...
    try {
      ...
      internalPlayer.playerID = builder.playerID;
      ...
      sendRendererMessage(TRACK_TYPE_VIDEO, MSG_SET_PRIORITY, builder.priority);
